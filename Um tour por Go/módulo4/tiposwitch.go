...
A declaração em um _type switch_ tem a mesma sintaxe como uma afirmação de tipo de i.(T), mas o tipo específico t é
substituído com a palavra-chave type.

Nisso a instrução switch testa se o valor de interface i detém um valor de tipo T ou S.
Em cada um dos casos T e S, a variável v será do tipo T ou S respectivamente e guarda o valor mantido por i.
